...
namespace TarodevController {
    ...
    public class ScriptableStats : ScriptableObject {
        ...
        [Tooltip("The attack damage cooldown of your players basic attack")]
        public int AttackDamage = 10;

        [Tooltip("The attack range cooldown of your players basic attack")]
        ...
        [Tooltip("Player's max life")]
        public float MaxHealth = 3;

        [Tooltip("The current life of players")]
